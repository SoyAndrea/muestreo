...
```
Para calcular exactamente el CV y el deff de las estimaciones seria necesario conocer el total de
personas en la poblacion
...
nh = data.frame(Zona = tabla_datos$zona,
                n_neyman = round(n * sqrt(tabla_datos$sh2) * tabla_datos$wh / sum(tabla_datos$wh * sqrt(tabla_datos$sh2))))
