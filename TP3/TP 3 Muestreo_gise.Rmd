...
```{r importo datos}
Resultados_Octubre_2023_PRESIDENCIALES <- read_csv("C:/Users/Gisele/Desktop/Resultados_Octubre_2023_PRESIDENCIALES.csv")
...
El ejercicio indica una Muestral aleatoria, estratificada, de 80 UPEs, estratificando el marco de muestreo en estas zonas: CABA, Partidos del Conurbano Bonaerense, Resto de Buenos Aires
...
resumen_estratos <- presidenciales %>%
  group_by(estrato) %>%
  summarise(
    circuitos = n_distinct(seccion_nombre),  # Número de circuitos (secciones)
